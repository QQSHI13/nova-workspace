# Collect Windows App Inventory for Fresh Start
# Run this in PowerShell (Run as normal user, not Administrator unless needed)

Write-Host "=== Collecting Windows App Inventory ===" -ForegroundColor Cyan

# Create output directory
$outputDir = "$env:USERPROFILE\Desktop\windows-app-inventory"
...
Write-Host "   Saved to: windows-installed-programs.txt" -ForegroundColor Green
